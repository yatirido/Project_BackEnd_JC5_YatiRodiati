...
{this.state.priceproduct} 
                ...
                <div className="form-group">
                    ...
                    <div className="col-lg-10">
                        <input ref="nameproduct" type="text" Value={this.state.nameproduct} className="form-control" />
                    </div>
                </div>
                 ...
                 <div className="form-group">
                    ...
                    <div className="col-lg-10">
                        <input ref="idcategory" type="text" Value={this.state.idcategory} className="form-control" />
                    </div>
                </div>
                ...
                <div className="form-group">
                    ...
                    <div className="col-lg-10">
                        <input ref="priceproduct" type="text" Value={this.state.priceproduct} className="form-control" />
                    </div>
                </div>
